...
sealed interface AuthorDetailUiState : BaseUiState {
    data object Loading : AuthorDetailUiState
    data class Success(
        val author: AuthorResource,
        val authorQuotes: Flow<PagingData<QuoteResource>>
    ) : AuthorDetailUiState
    data class Error(val error: StringResource) : AuthorDetailUiState
}