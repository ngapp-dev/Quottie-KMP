...
package com.ngapp.quottie.onboarding.fake
...
/** Minimal in-memory fake covering exactly what [com.ngapp.quottie.onboarding.OnboardingViewModel] uses. */
class FakeUserDataRepository : UserDataRepository {
    ...
    override suspend fun setShouldHideOnboarding(shouldHideOnboarding: Boolean) {
        state.value = state.value.copy(shouldHideOnboarding = shouldHideOnboarding)
    }

    override suspend fun setDarkThemeConfig(darkThemeConfig: DarkThemeConfig) = error("Not used by this test")
